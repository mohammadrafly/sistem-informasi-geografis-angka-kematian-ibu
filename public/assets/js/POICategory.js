...
function fetchData() {
    ...
    $.ajax({
        url: BASEURL + 'dashboard/poi/category',
        type: 'GET',
        data: {
            page: currentPage,
...
function saveCategory() {
    ...
    ajaxRequest(`dashboard/poi/category${id ? '/update/' : ''}` + (id ? id : ''), 'POST', formData,
        function(response) {
...
function editCategory(categoryId) {  
    ajaxRequest('dashboard/poi/category/update/' + categoryId, 'GET', '',
        function(response) {
            console.log(response);
            toggleCollapse('form');
...
function deleteCategory(categoryId) {
    if (confirm("Are you sure you want to delete this category?")) {
        ajaxRequest('dashboard/poi/category/delete/' + categoryId, 'GET', null,
            function(response) {
                console.log(response);
