...
<body>
    <div class="flex item-center">
        <div class="flex justify-between w-full">
            <div class="w-full">
                <div id="map" class="w-full min-h-screen border border-black">
                </div>
                <div class="flex">
                    <div id="colorToggleButtonContainer" class="my-5 p-2 w-fit rounded-lg bg-blue-500 text-white"></div>
                    <button onclick="window.print()" class="my-5 p-2 w-fit rounded-lg bg-blue-500 text-white">Print</button>
                </div>
            </div>
        </div>
    </div>
